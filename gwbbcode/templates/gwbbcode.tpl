		...
		<td>
			<div class="build_container">
				<div class="profession">
					<a href="{gw_wiki_page_url}/{primary}"><img src="{gwbbcode_images_folder_url}/img_skin/{primary}.gif" border="0"/></a><a href="{gw_wiki_page_url}/{secondary}"><img src="{gwbbcode_images_folder_url}/img_skin/{secondary}.gif" border="0"/></a><span><a href="{gw_wiki_page_url}/{primary}"><b>{primary_display_name}</b></a> / <a href="{gw_wiki_page_url}/{secondary}"><b>{secondary_display_name}</b></a></span>
				</div>
				...
				<div class="template">
					<div class="template_input">
						<input class="gws_template_input" type="text" value="{template_code}" readonly="readonly"/>&nbsp;<a href="{pvx_wiki_page_url}/Special:DownloadTemplate?build={template_code}&amp;name={build_name}"><img src="{gwbbcode_images_folder_url}/img_skin/save.png" border="0" alt="save"/></a>
					</div>
...
</table><span class="build_template_error">{template_error_msg}</span>
<!-- END build -->

<!-- BEGIN attribute -->
<div>
	<div class="attribute_rank">{attribute_value}</div>
	<div class="attribute_name"><a href="{gw_wiki_page_url}/{attribute_name}">{attribute_name}</a></div>
</div>
<!-- END attribute -->

<!-- BEGIN icon -->
<div class="skill_box">
	<div class="skill_icon hovertooltip" data-tooltipid="load{load}">
		<div class="pvx_icon-{elite_or_normal}">
			<div class="pvx-type-{ty}"></div>
		</div>
		<a href="{gw_wiki_page_url}/{name_link}"><img src="{gwbbcode_images_folder_url}/img_skills/{id}.jpg" border="0"/></a>
	</div>
	<a href="{gw_wiki_page_url}/{name_link}">{name}</a></div>
<!-- END icon -->
