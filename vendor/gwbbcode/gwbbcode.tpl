...
<!-- BEGIN blank_icon -->
<img src="http://hydra-images.cursecdn.com/gwpvx.gamepedia.com/img_skills/{id}.jpg" style="vertical-align: middle;" />
<!-- END blank_icon -->
...
<div id="load{load}" style="display: none;">
    <div class="pvx_overlib" style="width:{desc_len}px;">
        ...
        <div class="pvx_description" style="background-image:url('http://hydra-images.cursecdn.com/gwpvx.gamepedia.com/img_skin/{profession}.jpg');">
